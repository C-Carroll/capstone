      ...
      <div className="background-drip">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill=" #ff8fb1"
            fill-opacity="1"
            d="M0,160L16,176C32,192,64,224,96,224C128,224,160,192,192,192C224,192,256,224,288,213.3C320,203,352,149,384,138.7C416,128,448,160,480,192C512,224,544,256,576,234.7C608,213,640,139,672,138.7C704,139,736,213,768,218.7C800,224,832,160,864,133.3C896,107,928,117,960,106.7C992,96,1024,64,1056,90.7C1088,117,1120,203,1152,218.7C1184,235,1216,181,1248,170.7C1280,160,1312,192,1344,181.3C1376,171,1408,117,1424,90.7L1440,64L1440,0L1424,0C1408,0,1376,0,1344,0C1312,0,1280,0,1248,0C1216,0,1184,0,1152,0C1120,0,1088,0,1056,0C1024,0,992,0,960,0C928,0,896,0,864,0C832,0,800,0,768,0C736,0,704,0,672,0C640,0,608,0,576,0C544,0,512,0,480,0C448,0,416,0,384,0C352,0,320,0,288,0C256,0,224,0,192,0C160,0,128,0,96,0C64,0,32,0,16,0L0,0Z"
          ></path>
        </svg>
      </div>
      <div className="CRHead">What did you think of this album?</div>
          ...
          <div className="starsCont">
            <div className="st">
              ...
              >
                <i
                  className={`fa-star ${
                    hovered >= 1 ? "fa-solid filled" : "fa-regular"
                  }`}
                ></i>
              </div>
              <div
              ...
              >
                <i
                  className={`fa-star ${
                    hovered >= 2 ? "fa-solid filled" : "fa-regular"
                  }`}
                ></i>
              </div>
              <div
              ...
              >
                <i
                  className={`fa-star ${
                    hovered >= 3 ? "fa-solid filled" : "fa-regular"
                  }`}
                ></i>
              </div>
              <div
              ...
              >
                <i
                  className={`fa-star ${
                    hovered >= 4 ? "fa-solid filled" : "fa-regular"
                  }`}
                ></i>
              </div>
              <div
              ...
              >
                <i
                  className={`fa-star ${
                    hovered >= 5 ? "fa-solid filled" : "fa-regular"
                  }`}
                ></i>
              </div>
            </div>
